...
-- -----------------------------------------------------
-- Schema af25willa1_college_db
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema af25willa1_college_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `af25willa1_college_db` DEFAULT CHARACTER SET utf8 ;
USE `af25willa1_college_db` ;

-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`people`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`people` (
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`department` (
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`semester`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`semester` (
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`room`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`room` (
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`course`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`course` (
  ...
  CONSTRAINT `fk_course_department`
    ...
    REFERENCES `af25willa1_college_db`.`department` (`department_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`faculty`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`faculty` (
  ...
  CONSTRAINT `fk_faculty_people`
    ...
    REFERENCES `af25willa1_college_db`.`people` (`people_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`course_offering`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`course_offering` (
  ...
  CONSTRAINT `fk_course_offering_course`
    ...
    REFERENCES `af25willa1_college_db`.`course` (`course_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_course_offering_semester`
    FOREIGN KEY (`semester_semester_id1`)
    REFERENCES `af25willa1_college_db`.`semester` (`semester_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_course_offering_room`
    FOREIGN KEY (`room_room_id1`)
    REFERENCES `af25willa1_college_db`.`room` (`room_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_course_offering_faculty`
    FOREIGN KEY (`faculty_faculty_id`)
    REFERENCES `af25willa1_college_db`.`faculty` (`faculty_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`letter_grade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`letter_grade` (
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`student` (
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`enrollment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`enrollment` (
  ...
  CONSTRAINT `fk_enrollment_letter_grade`
    ...
    REFERENCES `af25willa1_college_db`.`letter_grade` (`letter_grade_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_enrollment_student`
    FOREIGN KEY (`student_id`)
    REFERENCES `af25willa1_college_db`.`student` (`student_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_enrollment_course_offering`
    FOREIGN KEY (`course_offering_id`)
    REFERENCES `af25willa1_college_db`.`course_offering` (`course_offering_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `af25willa1_college_db`.`staff`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `af25willa1_college_db`.`staff` (
